function insert(){
    ...
    $("#enviar").click(function(){
        ...
        $.post("./funciones_php/insertar.php",{'comunidad' : comunidad, 'ciudad' : ciudad,'zona' : zona,'calle' : calle,
         'numero' : numero, 'piso' : piso, 'tipoCasa' : tipoCasa,'anio' : anio, 'habitaciones' : habitaciones, 
         'preciom2' : preciom2,'informacion' : informacion,'duenio' : duenio,
         'm2' : m2,'precio' : precio,'banios' : banios},function(data,estado){
             if(estado=='success'){
