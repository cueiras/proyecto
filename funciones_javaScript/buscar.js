function buscar() {
	$("#buscar").click(function () {
		...
		if (comunidad != null && ciudad != null) {
			...
			$("#error").text("Es necesario selecionar como minimo la comunidad y la cuidad")
		}
...
function cargarCiudades() {
	$("#comunidad").on('change', function () {
		var comunidad = $("#comunidad").val();
		$.get("./funciones_php/select_ciudades.php", {
			'comunidad': comunidad
		}, function (data, estado) {
...
function cargarZonas() {
	$("#ciudad").change(function () {
		...
		$.get("./funciones_php/select_zonas.php", {
			'ciudad': ciudad
		}, function (data, estado) {
			if (estado == 'success') {
