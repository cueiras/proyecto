...
function generar_carrousel(){
	...
	$sql = "select calle,numero,precio from pisos where id_piso='$numero'";
	
	$res = $conexion->query($sql);

	while ($nfila = $res->fetch_object()) {
	echo"<div class='slide-one-item home-slider owl-carousel'>";
    echo"<div class='site-blocks-cover overlay' style='background-image: url(../images/hero_bg_1.jpg);' data-aos='fade' data-stellar-background-ratio='0.5'>";
