...
function cargaPisos(){
	...
	$sql = "SELECT pisos.id_piso,pisos.imagenPrincipal,pisos.precio,pisos.habitaciones,pisos.banios,
        pisos.m2,pisos.tipo_casa,pisos.anio,pisos.informacion,pisos.precio_m2,
    ...
    "m2" => "$nfila->m2","tipo_casa" => "$nfila->tipo_casa","anio" => "$nfila->anio","informacion" => "$nfila->informacion","precio_m2" => "$nfila->precio_m2",
